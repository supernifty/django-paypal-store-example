...
DATABASE_NAME = '/tmp/sampleapp.db'             # Or path to database file if using sqlite3.
...
SECRET_KEY = '4b(ek94$7x1obt55)vcr5vk=lr&wp-lh!olpfz#!q2_!+^6+_v'
